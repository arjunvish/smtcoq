...
(* Test Unit *) (* mul_1_l 34 *) (* Result: exception *) 
(* Fail timeout 20 (time abduce 1). *)
(* Output: Anomaly
"Uncaught exception Failure("Atom op_0 (aka digits) is not of the expected type")." *)
 rewrite Z.mul_1_l.
 ...
 apply Zmod_small;
  ...
  (* Test Unit *) (* mul_1_l 35 *) (* Result: exception *)
  (* Fail timeout 20 (time abduce 1). *)
...
"Uncaught exception Failure("Atom op_0 (aka digits) is not of the expected type")." *)
 ...
 apply Zmod_small;
  generalize (Z_mod_lt x wB wB_pos) (Z_mod_lt y wB wB_pos); lia.
(* Test Unit *) (* mul_1_l 36 *) (* Result: exception *)
(* Fail timeout 20 (time abduce 1). *)
(* Output: The command has indeed failed with message:
Anomaly
"Uncaught exception Failure("Atom op_0 (aka digits) is not of the expected type")."*)
...
(* Test Unit *) (* mul_1_l 37 *) (* Result: exception *)
