...
Proof.
  ...
  assert (Hq1 : 0 < q1) by (apply Z.mul_lt_mono_pos_r with p1; admit).
  destruct (IH p1) with p n as (r1,Hr1). 3-4: assumption. 1-2: admit.
  transitivity (q1 * p1); trivial. exists q1; auto with zarith.
  destruct (IH q1) with p n as (r2,Hr2). 3-4: assumption. 2: admit.
  split. admit.
  ...
  (* x = 0 *)
  exists n; destruct H. 
  (* Test Unit *) (* mul_0_r 8 *) (* Result: exception *) (* Require Import SMTCoq.SMTCoq. Fail timeout 20 (time abduce 1). smt. *) rewrite Z.mul_0_r in H; auto.
Admitted.
