...
(* Test Unit *) (* mul_1_l 33 *) (* Result: exception *) 
(* assert (a = aa /\ Z.pos b = bb -> aa # Z.to_pos bb = a # b) by admit.
assert (1 * bb = bb) by admit. assert (1 * aa = aa) by admit.
Require Import SMTCoq.SMTCoq. verit. *)
(* Output: Anomaly
"Uncaught exception Failure("Atom ( * 1 op_1 (aka bb)) is not of the expected type")."
Please report at http://coq.inria.fr/bugs/.
cvc4 fails since SMTCoq fails to send H but SMT file returns unsat *)
