...
(* Test Unit *) (* mul_reg_r 1 *) (* Result: timeout *) 
(* assert (QDen y <> 0%Z) by admit.
assert ((Qnum x * QDen z * QDen y)%Z = (Qnum z * QDen x * QDen y)%Z)
by admit.
fold mul' in *. Fail timeout 20 (time abduce 3). *)
(* Output: Tactic call ran for 0.097 secs (0.036u,0.016s) (failure)
