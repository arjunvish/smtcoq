...
Proof.
 ...
 - (* Test Unit *) (* mul_1_l 41 *) (* Result: abduce success *)
   (* fold mul' in *. rewrite Hf. Fail timeout 20 (time abduce 1).
   assert ((mul' 1 k) = k). { Search (1 * _ = _). apply Z.mul_1_l. }
   smt. *)
(* Output: Tactic call ran for 0.153 secs (0.002u,0.01s) (failure)
