(* S/W:
      cvc5 v1.1.1
      Coq & CoqIDE v8.13.2
   H/W: 16 GB RAM, Ubuntu 20.04
   Results:
      14 abduce success (16 calls to abduce, 2 problems have 2 calls)
      33 smt success
      12 timeout
      34 unsupported
*)
...
(** THIS FILE IS DEPRECATED.
   ...
   Proof. Fail Timeout 20 (time abduce 1). Admitted.
   (* Discarding the following lemma (unsupported): (~ Zne n m : Prop)
[Lemma,SMTCoq plugin]
Tactic call ran for 0.095 secs (0.01u,0.017s) (failure)
...
n = m *)
   ...
   Proof. Fail Timeout 20 (time abduce 4). Admitted.
   (* Tactic call ran for 3.832 secs (0.01u,0.016s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
m = n
...
(Z.succ m) <= (Z.succ n) *)
   ...
   Proof. Fail Timeout 20 (time abduce 1). Admitted.
   (* Tactic call ran for 19.181 secs (0.007u,0.02s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
(Z.succ n) + 1 = (Z.succ m) *)
   ...
   Proof. Fail Timeout 20 (time abduce 1). Admitted.
   (* Tactic call ran for 0.121 secs (0.008u,0.024s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n <= m *)
   ...
   (* Tactic call ran for 0.131 secs (0.002u,0.03s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
m = n
...
*)
   ...
   Proof. Fail Timeout 20 (time abduce 1). Admitted.
   (* Tactic call ran for 0.13 secs (0.014u,0.024s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n <= m
 *)
   ...
   (* Tactic call ran for 0.268 secs (0.u,0.018s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n + 1 <= (Z.succ n)
 *)
   ...
   Proof. Fail Timeout 20 (time abduce 1).
   (* Tactic call ran for 0.278 secs (0.005u,0.027s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n + 1 <= (Z.succ n) *)
   ...
   (* Tactic call ran for 0.648 secs (0.01u,0.024s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
(Z.succ n) <= n
...
(Z.succ n) <= m
(Z.succ n) <= 1 + n *)
   assert ((Z.succ n) <= 1 + n). { unfold Z.succ. smt. }
   smt.
   Qed.
   ...
   Proof. Fail Timeout 20 (time abduce 1).
   (* Tactic call ran for 0.34 secs (0.01u,0.015s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
(Z.succ m) = 1 + m *)
   ...
   Proof. Fail Timeout 20 (time abduce 1).
   (* Tactic call ran for 0.335 secs (0.001u,0.031s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
(Z.succ m) = 1 + m *)
   ...
   (* Tactic call ran for 0.453 secs (0.01u,0.027s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
(Z.succ n) <= n
...
1 + n = (Z.succ n)*)
   ...
   Proof. Fail Timeout 20 (time abduce 4).
   (* Tactic call ran for 1.295 secs (0.001u,0.02s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
m = n
...
(Z.succ m) <= m + 1 *)
   ...
   Proof. Fail Timeout 20 (time abduce 4).
   (* Tactic call ran for 1.296 secs (0.002u,0.021s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
m = n
...
(Z.succ m) <= m + 1 *)
   ...
   (* Tactic call ran for 2.101 secs (0.01u,0.02s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
1 + n <= m
(Z.succ n) = 1 + n *)
   ...
   Proof. Fail Timeout 20 (time abduce 4).
   (* Tactic call ran for 0.293 secs (0.011u,0.023s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n = m
...
n <= (Z.succ n)
   ...
   Proof. Fail Timeout 20 (time abduce 2).
   (* Tactic call ran for 3.689 secs (0.016u,0.014s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n + 1 = (Z.pred m)
n + 1 <= (Z.pred m) *)
   ...
   { unfold Z.pred. Fail Timeout 20 (time abduce 2).
   (* abduce success *)
   (* Tactic call ran for 1.801 secs (0.014u,0.016s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n + 2 <= m
(Z.succ n) = n + 1 *)
     assert ((Z.succ n) = n + 1). { unfold Z.succ. smt. } smt. 
   }
   smt.
   Qed.
   ...
   Proof. Fail Timeout 20 (time abduce 2).
   (* Tactic call ran for 3.684 secs (0.008u,0.02s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n + 1 = (Z.pred m)
...
*)
   ...
   { unfold Z.pred. Fail Timeout 20 (time abduce 2).
   (* abduce success *)
   (* Tactic call ran for 1.47 secs (0.001u,0.019s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n + 2 <= m
...
*)
   ...
   Proof. Fail Timeout 20 (time abduce 4).
   (* Tactic call ran for 0.297 secs (0.01u,0.018s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
1 <= (Z.pred n)
...
(Z.pred n) + 1 = n *)
   ...
   Proof. Fail Timeout 20 (time abduce 2). Admitted.
   (* Tactic call ran for 0.217 secs (0.001u,0.032s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
1 <= p + q
0 <= p + q *)
   ...
   Proof. Fail Timeout 20 (time abduce 1). Admitted.
   (* Tactic call ran for 0.085 secs (0.006u,0.024s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
1 <= p *)
   ...
   Proof. Fail Timeout 20 (time abduce 1). Admitted.
   (* Tactic call ran for 0.074 secs (0.001u,0.019s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
0 <= p *) 
   ...
   Proof. Fail Timeout 20 (time abduce 1). Admitted.
   (* Tactic call ran for 0.067 secs (0.001u,0.019s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
1 <= p *)
   ...
   Proof. Fail Timeout 20 (time abduce 1). Admitted.
   (* Tactic call ran for 0.116 secs (0.u,0.027s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
0 <= (Z.of_nat n) *)
   ...
   Proof. Fail Timeout 20 (time abduce 4).
   (* Tactic call ran for 2.528 secs (0.021u,0.015s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n = m
...
(Z.succ n) = 1 + n *)
   ...
   Proof. (* Fail Timeout 20 (time abduce 1). *) 
   (*fold mul' in *. intros. Fail Timeout 20 (time abduce 5).
Tactic call ran for 4.176 secs (0.013u,0.035s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
m = n
...
Admitted.
   ...
   Proof. (* Fail Timeout 20 (time abduce 1). *) 
    fold mul' in *. intros. Fail Timeout 20 (time abduce 6).
(*Tactic call ran for 5.163 secs (0.013u,0.043s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
m = n
...
Admitted.
   ...
   Proof. (* Fail Timeout 20 (time abduce 1). *)
    (*fold mul' in *. intros. Fail Timeout 20 (time abduce 1).
    The command has indeed failed with message:
Timeout!*)
Admitted.
   (* Solver error: (error A non-linear fact was asserted to arithmetic in a linear logic. *)
...
Timeout! *) Admitted.
   ...
   Proof. (*Fail Timeout 20 (time abduce 1).*)
    (*fold mul' in *. intros. Fail Timeout 20 (time abduce 6).
Tactic call ran for 11.069 secs (0.014u,0.036s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
m = n
...
p + m <= 1 + n*)
  Admitted.
   ...
   Proof. (* Fail Timeout 20 (time abduce 1). *) 
   (* fold mul' in *. intros. Fail Timeout 20 (time abduce 8). 
Tactic call ran for 14.103 secs (0.009u,0.045s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
m = n
...
Admitted.
   ...
   Proof. (* Fail Timeout 20 (time abduce 1). *) 
   (* fold mul' in *. intros. Fail Timeout 20 (time abduce 6).
Tactic call ran for 10.85 secs (0.016u,0.036s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
m = n
...
Admitted.
   ...
   Proof. (* Fail Timeout 20 (time abduce 1). *) 
   (* fold mul' in *. intros. Fail Timeout 20 (time abduce 6).
Tactic call ran for 9.754 secs (0.007u,0.039s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
m = n
...
Admitted.
   ...
   Proof. (* Fail Timeout 20 (time abduce 1). *) 
   (* fold mul' in *. intros. Fail Timeout 20 (time abduce 14).
Tactic call ran for 9.263 secs (0.021u,0.031s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
n + m = p
...
Admitted.
   ...
   Proof. (* Fail Timeout 20 (time abduce 1). *) 
(*fold mul' in *. intros. Fail Timeout 20 (time abduce 23).
Tactic call ran for 18.928 secs (0.02u,0.036s) (failure)
The command has indeed failed with message:
cvc5 returned SAT.
The solver cannot prove the goal, but one of the following hypotheses (printed in Prop, but the corresponding Boolean versions also apply) would make it provable:
p + q = m
